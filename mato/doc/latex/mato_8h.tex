...
\begin{center}
\leavevmode
\includegraphics[width=131pt]{mato_8h__dep__incl}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em List of modules descriptions consists of structures describing the basic information about a module. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
typedef void($\ast$ \mbox{\hyperlink{mato_8h_a5cdf8c706be95dbe5dc32dda2d0aacdf}{start\+\_\+instance\+\_\+callback}}) (void $\ast$\mbox{\hyperlink{mato_8c_a0e0d7e8d878428833528a1123d6558c5}{instance\+\_\+data}})
...
typedef void($\ast$ \mbox{\hyperlink{mato_8h_a19ec8ae2c73a767ac23bcc3c861e8b53}{delete\+\_\+instance\+\_\+callback}}) (void $\ast$\mbox{\hyperlink{mato_8c_a0e0d7e8d878428833528a1123d6558c5}{instance\+\_\+data}})
...
typedef void($\ast$ \mbox{\hyperlink{mato_8h_a984f52f0434bb9e42814bf9c74f4791d}{global\+\_\+message\+\_\+callback}}) (void $\ast$\mbox{\hyperlink{mato_8c_a0e0d7e8d878428833528a1123d6558c5}{instance\+\_\+data}}, int module\+\_\+id\+\_\+sender, int message\+\_\+id, int msg\+\_\+length, void $\ast$message\+\_\+data)
...
typedef void($\ast$ \mbox{\hyperlink{mato_8h_a9345221b935d9505595c583b54d31e86}{subscriber\+\_\+callback}}) (void $\ast$\mbox{\hyperlink{mato_8c_a0e0d7e8d878428833528a1123d6558c5}{instance\+\_\+data}}, int sender\+\_\+module\+\_\+id, int data\+\_\+length, void $\ast$new\+\_\+data\+\_\+ptr)
...
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{mato_8h_a96f8e9e3c32c9abdab14dabd590fae87}{mato\+\_\+init}} ()
\begin{DoxyCompactList}\small\item\em Initialize the whole framework. Should be called first from the main program. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Retrieve the most recently posted data of some channel of some module instance. \end{DoxyCompactList}\item 
\mbox{\Hypertarget{mato_8h_aedcb803fd4a991e805e6c3813c829a35}\label{mato_8h_aedcb803fd4a991e805e6c3813c829a35}} 
...
{\footnotesize\ttfamily typedef void($\ast$ global\+\_\+message\+\_\+callback) (void $\ast$\mbox{\hyperlink{mato_8c_a0e0d7e8d878428833528a1123d6558c5}{instance\+\_\+data}}, int module\+\_\+id\+\_\+sender, int message\+\_\+id, int msg\+\_\+length, void $\ast$message\+\_\+data)}
...
{\footnotesize\ttfamily typedef void($\ast$ start\+\_\+instance\+\_\+callback) (void $\ast$\mbox{\hyperlink{mato_8c_a0e0d7e8d878428833528a1123d6558c5}{instance\+\_\+data}})}
...
{\footnotesize\ttfamily typedef void($\ast$ subscriber\+\_\+callback) (void $\ast$\mbox{\hyperlink{mato_8c_a0e0d7e8d878428833528a1123d6558c5}{instance\+\_\+data}}, int sender\+\_\+module\+\_\+id, int data\+\_\+length, void $\ast$new\+\_\+data\+\_\+ptr)}
...
Each thread that terminates should call this function just before it quits. \mbox{\Hypertarget{mato_8h_af356c7284b6f1d6be285de40d9e23b77}\label{mato_8h_af356c7284b6f1d6be285de40d9e23b77}} 
...
Data is copied into the buffer provided, and the length of the data is set to data\+\_\+length. The calling module should release the memory by calling free() when it is not needed anymore. \mbox{\Hypertarget{mato_8h_a5c6a3a9b7e7969e9d9324b1d937ff2a5}\label{mato_8h_a5c6a3a9b7e7969e9d9324b1d937ff2a5}} 
...
Each module instance (or other part of the program) that creates a new thread should call this funciton for each newly created thread. \mbox{\Hypertarget{mato_8h_a96f8e9e3c32c9abdab14dabd590fae87}\label{mato_8h_a96f8e9e3c32c9abdab14dabd590fae87}} 
...
Initialize the whole framework. Should be called first from the main program. \mbox{\Hypertarget{mato_8h_a43f0570e3ab59d7a021e93113437dcaf}\label{mato_8h_a43f0570e3ab59d7a021e93113437dcaf}} 
...
This is typically called from the init() function of each module type, which should be called directly from the main program. \mbox{\Hypertarget{mato_8h_a62a0865fa5114c0a254435a1369531cf}\label{mato_8h_a62a0865fa5114c0a254435a1369531cf}} 
