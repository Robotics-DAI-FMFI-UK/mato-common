...
typedef void($\ast$ \mbox{\hyperlink{mato_8h_a5cdf8c706be95dbe5dc32dda2d0aacdf}{start\+\_\+instance\+\_\+callback}}) (void $\ast$instance\+\_\+data)
...
typedef void($\ast$ \mbox{\hyperlink{mato_8h_a19ec8ae2c73a767ac23bcc3c861e8b53}{delete\+\_\+instance\+\_\+callback}}) (void $\ast$instance\+\_\+data)
...
typedef void($\ast$ \mbox{\hyperlink{mato_8h_a984f52f0434bb9e42814bf9c74f4791d}{global\+\_\+message\+\_\+callback}}) (void $\ast$instance\+\_\+data, int module\+\_\+id\+\_\+sender, int message\+\_\+id, int msg\+\_\+length, void $\ast$message\+\_\+data)
...
typedef void($\ast$ \mbox{\hyperlink{mato_8h_a9345221b935d9505595c583b54d31e86}{subscriber\+\_\+callback}}) (void $\ast$instance\+\_\+data, int sender\+\_\+module\+\_\+id, int data\+\_\+length, void $\ast$new\+\_\+data\+\_\+ptr)
...
\begin{DoxyCompactItemize}
\item 
\mbox{\Hypertarget{mato_8h_a96f8e9e3c32c9abdab14dabd590fae87}\label{mato_8h_a96f8e9e3c32c9abdab14dabd590fae87}} 
...
\mbox{\Hypertarget{mato_8h_a480acc181ff3a7d7c925d64e3d4a7442}\label{mato_8h_a480acc181ff3a7d7c925d64e3d4a7442}} 
...
{\footnotesize\ttfamily typedef void($\ast$ global\+\_\+message\+\_\+callback) (void $\ast$instance\+\_\+data, int module\+\_\+id\+\_\+sender, int message\+\_\+id, int msg\+\_\+length, void $\ast$message\+\_\+data)}
...
{\footnotesize\ttfamily typedef void($\ast$ start\+\_\+instance\+\_\+callback) (void $\ast$instance\+\_\+data)}
...
{\footnotesize\ttfamily typedef void($\ast$ subscriber\+\_\+callback) (void $\ast$instance\+\_\+data, int sender\+\_\+module\+\_\+id, int data\+\_\+length, void $\ast$new\+\_\+data\+\_\+ptr)}
...
If this starts growing, the callbacks take too much time to process data and should be refactored. \mbox{\Hypertarget{mato_8h_af356c7284b6f1d6be285de40d9e23b77}\label{mato_8h_af356c7284b6f1d6be285de40d9e23b77}} 
...
The list should be freed by calling \mbox{\hyperlink{mato_8h_aeafc9d85e29a73b9b5423cd661bd54c2}{mato\+\_\+free\+\_\+list\+\_\+of\+\_\+modules()}} when it is not needed anymore. \mbox{\Hypertarget{mato_8h_a43f0570e3ab59d7a021e93113437dcaf}\label{mato_8h_a43f0570e3ab59d7a021e93113437dcaf}} 
...
This is typically called from the init() function of each module type, which should be called directly from the main program. 
