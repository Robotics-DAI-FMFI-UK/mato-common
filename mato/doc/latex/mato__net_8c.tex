...
\begin{DoxyCompactList}\small\item\em Receive and process new module instance message from another node. For the packet format, see \mbox{\hyperlink{mato__net_8c_a89b6e0a431131bbd10afb037237fc9d5}{net\+\_\+announce\+\_\+new\+\_\+module()}} function. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Receive and process a delete module message from another node. For the packet format see net\+\_\+send\+\_\+delete\+\_\+module() function. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Receive and process a subscribe channel message from another node. For the packet format see net\+\_\+send\+\_\+subscribe() function. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Receive and process a unsubscribe channel message from another node. For the packet format see net\+\_\+send\+\_\+subscribe() function. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Receive and process a global message from another node. For the packet format see net\+\_\+send\+\_\+global\+\_\+message() function. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Request data from a channel of a module on a different node. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Receive and process a delete module message from another node. For the packet format see net\+\_\+send\+\_\+delete\+\_\+module() function. 
...
Receive and process a global message from another node. For the packet format see net\+\_\+send\+\_\+global\+\_\+message() function. 
...
Receive and process new module instance message from another node. For the packet format, see \mbox{\hyperlink{mato__net_8c_a89b6e0a431131bbd10afb037237fc9d5}{net\+\_\+announce\+\_\+new\+\_\+module()}} function. 
...
Receive and process a subscribe channel message from another node. For the packet format see net\+\_\+send\+\_\+subscribe() function. 
...
Receive and process a unsubscribe channel message from another node. For the packet format see net\+\_\+send\+\_\+subscribe() function. 
...
See net\+\_\+recv\+\_\+int32\+\_\+t() function. \mbox{\Hypertarget{mato__net_8c_a9ea1de88471a17079784028998ea2318}\label{mato__net_8c_a9ea1de88471a17079784028998ea2318}} 
